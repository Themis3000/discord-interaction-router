...
abstract class BaseContext {
  ...
  protected constructor(client: Client, data: Record<string, unknown>, nextId: string) {
    this.client = client;
    this.data = data;
    this.nextId = nextId;
  }
...
export class StepContext extends BaseContext {
  ...
  constructor(client: Client, interaction: MessageComponentInteraction | ModalSubmitInteraction | Message, data: Record<string, unknown>, nextId: string, optionSelected?: number) {
...
export class CommandContext extends BaseContext {
  ...
  constructor(client: Client, interaction: CommandInteraction, data: Record<string, unknown>, nextId: string) {
    super(client, data, nextId);
    this.interaction = interaction
  }
}
